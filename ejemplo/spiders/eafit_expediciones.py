...
class eafit_expediciones(scrapy.Spider):
    name = 'eafit_expediciones'
    start_urls = ["http://bitacora.eafit.edu.co/expediciones/"]
    def parse(self,response):
        links = response.xpath("//div/p/a/@href").getall()
        for link in links:
