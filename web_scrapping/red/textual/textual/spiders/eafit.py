...
class eafit(scrapy.Spider):
    ...
    def parse(self,response):
        ...
        #itinerario
        links.append(procesar_peticion.eafit(1,10509,"0d23021",2791))
        links.append(procesar_peticion.eafit(1,10509,"0d23021",2793))
        links.append(procesar_peticion.eafit(1,10509,"0d23021",2825))
        #experiencias
